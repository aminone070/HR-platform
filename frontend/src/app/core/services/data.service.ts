...
export class DataService {
  ...
  getWorkforceMetrics(): Observable<any> {
    return this.http.get(`${this.baseUrl}/workforce-metrics.json`).pipe(delay(600));
  }
  ...
  getPerformanceMetrics(): Observable<any> {
    return this.http.get(`${this.baseUrl}/performance-metrics.json`).pipe(delay(700));
  }
  ...
  getTurnoverMetrics(): Observable<any> {
    return this.http.get(`${this.baseUrl}/turnover-metrics.json`).pipe(delay(550));
  }
  ...
  getHiringForecast(): Observable<any> {
    return this.http.get(`${this.baseUrl}/hiring-forecast.json`).pipe(delay(800));
  }
  ...
  getEmployees(): Observable<any[]> {
    return this.http.get<any[]>(`${this.baseUrl}/employees.json`).pipe(delay(400));
  }
  ...
  getReportTemplates(): Observable<any[]> {
    return this.http.get<any[]>(`${this.baseUrl}/report-templates.json`).pipe(delay(500));
  }
