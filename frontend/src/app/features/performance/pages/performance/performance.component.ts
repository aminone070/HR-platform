      ...
      <div class="main-grid">
        ...
        <div class="card-3d">
          ...
          <div class="card-body" style="padding-top:8px;">
            <div *ngFor="let p of leaders; let i = index" class="perf-row">
              <div
                style="font-size:13px;font-weight:700;color:var(--gray-300);width:20px;text-align:center;flex-shrink:0;"
              >
                {{ i + 1 }}
              </div>
        ...
        <div style="display:flex;flex-direction:column;gap:16px;">
          ...
          <div class="card-3d" style="padding:20px;text-align:center;">
            <div
              style="font-size:12px;color:var(--gray-400);font-weight:500;text-transform:uppercase;letter-spacing:.06em;margin-bottom:10px;"
            >
              Company Average
            </div>
          ...
          <div class="card-3d" style="flex: 1; display: flex; flex-direction: column;">
            ...
            <div class="card-body" style="padding-top:12px;padding-bottom:12px; flex: 1; display: flex; flex-direction: column; justify-content: center;">
              <div *ngFor="let d of distribution" class="dist-row">
                ...
                <div class="dist-bar">
                  <div class="dist-fill" [style.width.%]="d.pct" [style.background]="d.color"></div>
                </div>
...
export class PerformanceComponent {
  ...
  goals = [
    {
      name: 'Reduce employee churn to <5%',
      owner: 'L. Hassan',
      progress: 72,
      color: '#4f6ef7',
      status: 'On Track',
    ...
    {
      name: 'Complete 100% review cycle',
      owner: 'All Managers',
      progress: 66,
      color: '#16a34a',
      status: 'In Progress',
    ...
    {
      name: 'Increase avg score by 3pts',
      owner: 'S. Mitchell',
      progress: 84,
      color: '#06b6d4',
      status: 'On Track',
    ...
    {
      name: 'Launch mentorship program',
      owner: 'P. Sharma',
      progress: 30,
      color: '#7c5cfc',
      status: 'At Risk',
    ...
    {
      name: 'Achieve 95% attendance rate',
      owner: 'T. Nakamura',
      progress: 96,
      color: '#16a34a',
      status: 'Achieved',
