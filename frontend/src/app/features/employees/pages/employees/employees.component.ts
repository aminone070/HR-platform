        ...
        <div class="toolbar-left">
          <div class="search-box">
            ...
            <input
              ...
              [(ngModel)]="searchQuery"
              style="height:36px;font-size:13.5px;"
            />
          </div>
          <button
            *ngFor="let d of deptFilters"
            class="filter-chip"
            [class.active]="activeFilter() === d"
            (click)="activeFilter.set(d)"
          >
            {{ d }}
          </button>
        </div>
              ...
              <tr *ngFor="let e of paginated()">
                <td>
                  <div style="display:flex;align-items:center;gap:10px;">
                    <div class="row-avatar" [style.background]="e.avatarColor">
                      {{ e.initials }}
                    </div>
                    <div>
                      <div style="font-weight:500;color:var(--gray-900);font-size:13.5px;">
                        {{ e.name }}
                      </div>
                ...
                <td>
                  <span class="badge" [ngClass]="e.statusClass">{{ e.status }}</span>
                </td>
                <td>
                  <div style="display:flex;align-items:center;gap:8px;">
                    <div style="flex:1;min-width:60px;" class="progress-bar">
                      <div
                        ...
                        [style.background]="e.perfColor"
                      ></div>
                    </div>
                    <span style="font-size:12px;font-weight:600;color:var(--gray-700);width:32px;"
                      >{{ e.performance }}%</span
                    >
                  </div>
                </td>
...
export class EmployeesComponent {
  ...
  filtered = computed(() => {
    ...
    if (this.activeFilter() !== 'All')
      list = list.filter((e) => e.department === this.activeFilter());
